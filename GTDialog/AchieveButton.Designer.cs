...
namespace GTDialog
{
	partial class AchieveButton
	{
		...
		private void InitializeComponent()
		{
			...
			this.button1.Text = "Add Achieve Button";
			...
			this.label3.Text = "Achievement Icon ID";
			...
			this.Name = "AchieveButton";
			this.Text = "AchieveButton";
